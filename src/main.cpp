      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            // find the sourrouding cars，and make behavior plan
            bool ahead = false;
            bool left = false;
            bool right = false;
            ...
            // based on the udacity faq code demo

          	vector<double> ptsx;
            vector<double> ptsy;

            // define the referrence position
